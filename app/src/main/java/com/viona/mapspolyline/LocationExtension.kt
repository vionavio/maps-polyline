...
fun Marker.moveSmoothly(newLatLng: LatLng) {
    ...
    animator.addUpdateListener { animation ->
        ...
        val updateLat = this.position.latitude + deltaLat[0] * deltaStep * 1.0 /100
        val updateLon = this.position.longitude + deltaStep * deltaLon * 1.0 /100
        val updateLatLng = LatLng(updateLat, updateLon)
        this.position = updateLatLng
